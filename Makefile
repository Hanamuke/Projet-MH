...
#
SOURCES = Grille.cpp main_sub.cpp multithread.cpp
...
CXXFLAGS = -std=c++11 -O2 -funroll-loops -Wall -Werror -Wfatal-errors -Wno-unused -march=native -flto -fuse-linker-plugin
